                            ...
                            if (e == null && objects.size() > 0) {
                                ...
                                if (ContextCompat.checkSelfPermission(RiderActivity.this, Manifest.permission.ACCESS_FINE_LOCATION) == PackageManager.PERMISSION_GRANTED) {
                                    ...
                                    if (lastKnownLocation != null) {
                                        ...
                                        Double distanceInKilometres = driverLocation.distanceInKilometersTo(userLocation);

                                        if (distanceInKilometres < 0.01) {
                                            ...
                                            Double distanceOneDP = (double) Math.round(distanceInKilometres * 10) / 10;

                                            infoTextView.setText("Your driver is " + distanceOneDP.toString() + " kilometres away!");
                                            ...
                                            markers.add(mMap.addMarker(new MarkerOptions().position(requestLocationLatLng).title("Request Location                                                                                                                                                                                                                                                                                                                                                                  ").icon(BitmapDescriptorFactory.defaultMarker(BitmapDescriptorFactory.HUE_VIOLET))));
